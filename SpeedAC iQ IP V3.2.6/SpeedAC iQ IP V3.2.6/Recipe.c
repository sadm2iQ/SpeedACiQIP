/*------------------------------------------------------------------------- 
--  Procedure Name    : TargetWeighIPEntry
--  Created by        : Steve Santerre
--  Last modified on  : 2021/10
--  
--  Purpose           : Target WeightIP Entry 
--                    : 
--  Value Parameters  :
--  Variable Params   : Argument from Screen or PLC
                      :  
--  Side Effects      : 
--------------------------------------------------------------------------*/
void TargetWeighIPEntry(string Argument)
{
        ...
        // Layout of second column of recipe page on the right 
          ...
          beginlayout(LAYOUT_TYPE_GRID, 0,3); // 
            beginrow(); // First row with three columns 
              ...
              CreateInputField  (RECIPE_ROW19_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 6, 2, false, lsub(TX_WPPRESETFEEDRATE1), WD_WP_BOX, HT_WP_BOX, widget_locked );
            ...
            beginrow(); // Second row with three columns  
              ...
              CreateInputField  (RECIPE_ROW20_INPUT, FT_STANDARD_SIZE, FT_RTC_BOLD, INPUT_FORMAT_DECIMAL, 6, 2, false, lsub(TX_WPPRESETFEEDRATE2), WD_WP_BOX, HT_WP_BOX, widget_locked );
  ...
  switch (Scrn_No)
  {
                      ...
                      {      
                        ...
                        case RECIPE_ROW1_INPUT :   
                                                ...
                                                //Autotracking feature 
                                                  ...
                                                  if(WP.NominalWeight > WP.TargetWeightIP)
                                                   {
                                                    WP.TargetWeightIP = WP.NominalWeight;  //SADM2
                                                   }
    ...
    case SCREEN_RECIPE2 :
                     ...
                     {                    
                        ...
                        case RECIPE_ROW19_INPUT : WP.PresetFeedRate1 = Lim(1000,MP.MaxFeedRate,Argument);
                                                  break; 
                                                  
                        case RECIPE_ROW20_INPUT : WP.PresetFeedRate2 = Lim(1000,MP.MaxFeedRate,Argument);
                                                  break; 
